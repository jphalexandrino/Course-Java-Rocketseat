...
import br.com.jphalexandrino.todolist.utils.utils;
...
public class TaskController {
    ...
    //http://localhost:8080/task/328749238749234792-dawdadsdwad-13123123 - Variavel path
    @PutMapping("{id}")
    public ResponseEntity update(@RequestBody TaskModel taskModel, HttpServletRequest request, @PathVariable UUID id){
       ...
       utils.copyNunNullPropertyNames(taskModel, task);
